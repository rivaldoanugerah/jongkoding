...
(function($) {
    $(document).ready(function() {
        ...
        function addEditListeners() {
            ...
            $(".STX-button-modal-close").click(function(e) {
        ...
        var $iframeElementSettings = $editSlideModal.find(".iframe-element-settings");
            ...
            for (var key in obj) {
                if (key == "hover") {
                    ...
                    if (typeof val == "string" || typeof val == "number" || typeof val == "boolean") {
                        ...
                        } else if ($container.find('input[name="' + key + '"]').hasClass("color-picker")) {
                            if($container.find('input[name="' + key + '"]').next().hasClass("STX-color-picker")) {
                        ...
                        } else if ($container.find('input[name="' + key + '"]').hasClass("unit")) {
                        ...
                        for (var key2 in val) {
                            ...
                            if (typeof val2 == "boolean") $container.find('input[name="' + key + "." + key2 + '"]').prop("checked", val2);
